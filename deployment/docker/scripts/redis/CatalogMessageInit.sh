...
redis_hset "FUN_133" "Code API interceptor path" "/messageucolab/v1/application/code/*" "FUNCTIONAL" "INFORMATION"
redis_hset "FUN_134" "Code translation API interceptor path" "/messageucolab/v1/application/code/*/translation" "FUNCTIONAL" "INFORMATION"
