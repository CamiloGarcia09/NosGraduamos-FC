...
class EnvironmentTypeRequiredRuleTest {

    @Mock
    private CatalogPort catalogPort;

    private EnvironmentTypeRequiredRule rule;

    @BeforeEach
    void setUp() {
        lenient().when(catalogPort.getMessage(anyString())).thenReturn("user message");
        rule = new EnvironmentTypeRequiredRule(catalogPort);
    }

    @Test
    void validate_doesNotThrow_whenTypeIdIsPresent() {
    ...
    @Test
    void validate_throwsBusinessRuleException_whenTypeIdIsEmpty() {
