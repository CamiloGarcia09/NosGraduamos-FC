...
public final class FunctionalityEndDateValidRule extends RuleValidator<CreateFunctionalityDTO> {

    public FunctionalityEndDateValidRule(CatalogPort catalogPort) {
        super(catalogPort,
                Specifications.field(CreateFunctionalityDTO::getEndDate, new ValidDateSpecification()),
