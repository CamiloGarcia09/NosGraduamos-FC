...
public final class TokenEnvironmentUuidRule extends RuleValidator<TokenValidationContext> {

    public TokenEnvironmentUuidRule(CatalogPort catalogPort) {
        super(catalogPort,
                Specifications.field(context -> context.dto().getEnvironmentId(), new ValidUuidSpecification()),
